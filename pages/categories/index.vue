...
async function init() {
    loading.value = true
    let response = await youtubeService.getChannelPlayLists(channelIDs.es)
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li aria-current="page">
                      <div class="flex items-center">
                          ...
                          <span class="ms-1 text-sm font-medium text-blue-600 md:ms-2 dark:text-white">Categories</span>
                      </div>
                  </li>
              </ol>
          </nav>
